...
RSpec.describe "ClockInOuts", type: :request do
  ...
  describe "GET /following_user_clocks" do
    ...
    before(:each) do
      ...
      clock_at = DateTime.yesterday
      ClockInOut.create(user_id: followed.id, clock_in: clock_at, clock_out: clock_at + 9.hours, duration: 9.hours)
      ClockInOut.create(user_id: followed.id, clock_in: clock_at, clock_out: clock_at + 1.hours, duration: 1.hours)
      ClockInOut.create(user_id: followed.id, clock_in: clock_at, clock_out: clock_at + 3.hours, duration: 3.hours)
    end
